      ...
      <div className="brands reveal fade-in">
        ...
        <div className="brandslist">
          ...
          <div className="brandsicon reveal zoom-in delay-3">
            <img src="https://res.cloudinary.com/dkvxns0mb/image/upload/q_auto/f_auto/v1777175018/2026_04_26_04_18_IMG_1113_doyl3w.png" alt='Talking foot' />
          </div>
          <div className="brandsicon reveal zoom-in delay-4">
            <p>GL</p>
          </div>
          <div className="brandsicon reveal zoom-in delay-5">
            <img src= 'https://res.cloudinary.com/dkvxns0mb/image/upload/q_auto/f_auto/v1777175933/2026_04_26_04_56_IMG_1116_cqbs8m.png' alt="Guggin foods" />
          </div>
        </div>
      </div>
...
Have a project in mind? Let's discuss how I can bring your vision to life</p>
        ...
        <div className="contactlist">
          <div className="contactoption reveal slide-left delay-1">
            ...
            <div className="contacts">
              ...
              <div className="contacticon">
                <svg width="24px" height="24px" viewBox="0 -4 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" fill="#ffffff" stroke="#ffffff">
          ...
          <div className="contactoption reveal slide-up delay-2">
            <div className="contacts" onClick={() => window.location.href = "https://wa.me/2349031144875"}>
